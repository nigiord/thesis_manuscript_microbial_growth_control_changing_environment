...
\section{Steady-state analysis of model}
...
\section{Solution of optimal control problem}
...
\section{Specification and analysis of control strategies}
...
\subsubsection{Precursor-only strategy}
