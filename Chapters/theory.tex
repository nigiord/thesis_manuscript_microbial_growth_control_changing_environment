...
\section{Self-replicator model of resource allocation}
\label{sec:model}
...
\begin{figure}[!h]
\includegraphics[width=\textwidth]{./Fig/Fig1.eps}
...
\section{Growth-rate maximization of the self-replicator reproduces bacterial growth laws}
...
\section{Biomass maximization as an optimal control problem}
...
\section{Solution of the optimal control problem}
...
\section{Simple feedback control strategies: exploiting information on nutrients or precursors}
...
\begin{figure}[!h]
\centering
\includegraphics[height=5cm]{./Fig/Fig6.eps}
...
\section{A near-optimal feedback control strategy: exploiting information on the imbalance between precursors and the gene expression machinery}
...
\begin{figure}[!h]
\centering
\includegraphics[height=5cm]{./Fig/Fig7.eps}
...
\begin{figure}[!h]
\centering
\includegraphics[width=\textwidth]{./Fig/Fig8.eps}
...
\section{S1 Text -- Model derivation and analysis}
...
\subsection{Analysis of the control strategies}
...
\subsubsection{Nutrient-only strategy}
...
\section{S2 Text -- Model parameters}
...
\subsection*{\Large \texorpdfstring{$e_M$}{eM}}
...
\subsection*{\Large \texorpdfstring{$k_R$}{kR}}
...
\subsection*{\Large \texorpdfstring{$\beta$}{Beta}}
...
\subsection*{\Large \texorpdfstring{$E_M$}{EM} and \texorpdfstring{$K$}{K}}
...
\section{S3 Text -- Solution of optimal control problem}
...
\subsection{Analysis of the adjoint system}
...
\section[S4 Text -- Kinetic model of the ppGpp system]{S4 Text -- Kinetic model of the ppGpp system in \textit{Escherichia coli}}
\sectionmark{S4 Text -- Kinetic model of the ppGpp system}
\sectionmark{S4 Text -- Kinetic model of the ppGpp system}
...
\section{S1 Table -- Parameter values of self-replicator model}
...
\section{S1 Figure -- Simple control strategies for the self-replicator of bacterial growth}
