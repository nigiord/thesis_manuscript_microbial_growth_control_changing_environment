...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%% Personalized preambule %%%%
% For cross-referencing
\usepackage{xr}
\externaldocument[S1.]{supp_S1}
\externaldocument[S2.]{supp_S2}
\externaldocument[S3.]{supp_S3}
\externaldocument[S4.]{supp_S4}
...
\usepackage{xspace}
\newcommand*{\coli}{\textit{Escherichia coli}\xspace}
...
\tr{
\subsection*{Text S1 -- Model derivation and analysis}
\manuallabel{S1_Text}{S1}
%{\bf Lorem Ipsum.} Maecenas convallis mauris sit amet sem ultrices gravida. Etiam eget sapien nibh. Sed ac ipsum eget enim egestas ullamcorper nec euismod ligula. Curabitur fringilla pulvinar lectus consectetur pellentesque.

\subsection*{Text S2 -- Model parameters}
\manuallabel{S2_Text}{S2}
%{\bf Lorem Ipsum.} Maecenas convallis mauris sit amet sem ultrices gravida. Etiam eget sapien nibh. Sed ac ipsum eget enim egestas ullamcorper nec euismod ligula. Curabitur fringilla pulvinar lectus consectetur pellentesque.

\subsection*{Text S3 -- Solution of optimal control problem}
\manuallabel{S3_Text}{S3}
%{\bf Lorem Ipsum.} Maecenas convallis mauris sit amet sem ultrices gravida. Etiam eget sapien nibh. Sed ac ipsum eget enim egestas ullamcorper nec euismod ligula. Curabitur fringilla pulvinar lectus consectetur pellentesque.

\subsection*{Text S4 -- Kinetic model of the ppGpp system in \textit{Escherichia coli}}
\manuallabel{S4_Text}{S4}
%{\bf Lorem Ipsum.} Maecenas convallis mauris sit amet sem ultrices gravida. Etiam eget sapien nibh. Sed ac ipsum eget enim egestas ullamcorper nec euismod ligula. Curabitur fringilla pulvinar lectus consectetur pellentesque.
\subsection*{Table S1 -- Parameter values of self-replicator model}
\manuallabel{S1_Table}{S1}
%{\bf Lorem Ipsum.} Maecenas convallis mauris sit amet sem ultrices gravida. Etiam eget sapien nibh. Sed ac ipsum eget enim egestas ullamcorper nec euismod ligula. Curabitur fringilla pulvinar lectus consectetur pellentesque.

\subsection*{Figure S1 -- Simple control strategies for the self-replicator of bacterial growth}
\manuallabel{S1_Fig}{S1}
%{\bf Lorem Ipsum.} Maecenas convallis mauris sit amet sem ultrices gravida. Etiam eget sapien nibh. Sed ac ipsum eget enim egestas ullamcorper nec euismod ligula. Curabitur fringilla pulvinar lectus consectetur pellentesque.
