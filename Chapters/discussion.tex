...
Nous avons mis en place un cadre d'étude expérimentale dans lequel la distribution des ressources peut être observée lors d'une transition de croissance.
...
Par exemple, cela pourrait signifier l'optimisation de la biomasse produite lors d'une transition n'est pas un objectif pour la cellule.
