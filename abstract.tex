%\newgeometry{left=2.5cm,right=2.5cm,top=1.5cm,bottom=2cm}
...
Nous mesurons donc l'abondance des ribosomes chez \textit{Escherichia coli} au niveau de cellules individuelles lors d'un changement brutal de milieu de culture.
...
Nos résultats montrent que la capacité des systèmes de régulation à intégrer l'état de différentes variables physiologiques est cruciale dans l'optimisation de la croissance en environnement variable.
Au final, nous démontrons que les principes utilisés à l'état stationnaire peuvent, lorsqu'ils sont appliqués en dynamique, générer des comportements inattendus et expliquer plus en détails les stratégies de régulation employées par les micro-organismes.
\end{abstract}

\begin{resume-vulgaire}
Bactéries et autres micro-organismes se multiplient en utilisant la matière et l'énergie présentes dans leur environnement.
...
Ici, nous construisons un modèle simple de la croissance microbienne et utilisons la théorie du contrôle optimal pour déterminer la façon dont les cellules devraient agir lorsque leur environnement est soudainement modifié.
