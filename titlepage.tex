...
\Depot{ (fin Mars)} %% DATE DE LA SOUTENANCE
...
\UGTRapporteur{M, Matthew SCOTT}{Assoc. Prof.}{University of Waterloo}      %% 1er rapporteur
\UGTRapporteur{M, Guy-Bart STAN}{Reader}{Imperial College London}      %% second rapporteur

\UGTExaminateur{M, Olivier BERNARD}{DR}{Inria, Nice}     %% 2ème examinateur
\UGTExaminateur{M, Matthieu JULES}{CR}{Inra, Grignon}     %% 1er examinateur
\UGTExaminatrice{Mme, Irina MIHALCESCU}{Prof.}{Univ. Grenoble Alpes}    %% 3ème examinateur
...
\UGTInvite{M, Jean-Luc GOUZÉ}{DR}{Inria, Nice}
